-- This file is copied from "%CMDER_ROOT%\vendor\clink.lua".

-- "%CMDER_ROOT%\vendor\init.bat" loads "%CMDER_ROOT%\vendor\clink.lua", then
-- "%CMDER_ROOT%\vendor\clink.lua" loads "%CMDER_ROOT%\config\*.lua".

-- Customize: change the Cmder original prompt "λ" in variable 'lambda'.
